...
void vglClInit() {
    ...
    cl_context_properties properties[] = {
        ...
        CL_CONTEXT_PLATFORM,
        (cl_context_properties)cl.platformId[plat],
        0
    };
#elif defined WIN32
    cl_context_properties properties[] = {
        CL_GL_CONTEXT_KHR, (cl_context_properties)wglGetCurrentContext(), CL_WGL_HDC_KHR, (cl_context_properties)wglGetCurrentDC(), CL_CONTEXT_PLATFORM, (cl_context_properties)cl.platformId[plat], 0
    };
#endif
